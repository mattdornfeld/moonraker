...
class ActorValue(TFModelV2):
    def __init__(
        ...
        self.actor = self._build_actor(model_configs, num_outputs, vf_share_layers)
        self.register_variables(self.actor.variables)

    def _build_actor(
        self, model_configs: ModelConfigs, num_outputs: int, critic_share_layers: bool
    ) -> Model:
        """
