...
TEST_EXCHANGE_PKL_PATH = "fakebase_tests/data/test_exchange_checkpoint.p"
...
TEST_TRADE_ID = 1
TEST_SQL_SRC_DIR = f"{os.getcwd()}/fakebase_tests/data/moonraker.sql"
TMP_SQL_DIR = "/tmp/fakebase/docker-entrypoint-initdb.d"
