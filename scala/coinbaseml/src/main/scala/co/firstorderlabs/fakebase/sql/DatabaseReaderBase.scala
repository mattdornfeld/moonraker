...
import co.firstorderlabs.fakebase.{Configs, Snapshotable}
import co.firstorderlabs.fakebase.currency.Configs.ProductPrice.productId
import co.firstorderlabs.fakebase.protos.fakebase.{BuyLimitOrder, BuyMarketOrder, Cancellation, SellLimitOrder, SellMarketOrder}
...
abstract class DatabaseReaderBase(
  ...
  protected def buildQueryResult(timeInterval: TimeInterval): QueryResult =
    QueryResult(
